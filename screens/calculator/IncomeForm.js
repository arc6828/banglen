...
import { ScrollView, View, FlatList, Text, KeyboardAvoidingView, TextInput, Alert, Platform, TouchableWithoutFeedback, Keyboard, } from "react-native";
...
export default function IncomeForm(props) {
    ...
    const m = require("../../assets/jsons/income-menu.json");
    ...
    const onSave = async () => {
        ...
        await IncomeStorage.writeItem(token, d);
    ...
    const onRemove = async () => {
        ...
        await IncomeStorage.removeItem(token, d);
        navigation.navigate("Plan", { token: token });
